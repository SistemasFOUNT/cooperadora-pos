...
@section('title', 'Odonto - Reportes de Ventas')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="m-0"><i class="fas fa-chart-bar text-primary"></i> Reportes Odontológicos</h1>
            <p class="text-muted mb-0">Análisis de ventas por período y productos más vendidos</p>
        </div>
        <a href="{{ route('odonto.dashboard') }}" class="btn btn-outline-secondary btn-sm">
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('odonto.reportes') }}" class="row">
                <div class="col-md-3">
