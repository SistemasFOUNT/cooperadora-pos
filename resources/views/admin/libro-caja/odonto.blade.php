...
@section('title', 'Libro Caja - Centro Odontológico')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">Libro Caja - Centro Odontológico</h1>
...
@section('content')
    <div class="card card-outline card-info">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.libro-caja.odonto') }}" class="row g-3">
                <div class="col-md-4">
