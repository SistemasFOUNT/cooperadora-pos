...
return [
    ...
    */
    ...
    'title' => 'FOUNT Contable',
    'title_prefix' => '',
    'title_postfix' => ' - Cooperadora Odontología UNT',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here we can add custom CSS files to override AdminLTE styles.
    | Perfect for customizing images and other visual elements.
    |
    */
